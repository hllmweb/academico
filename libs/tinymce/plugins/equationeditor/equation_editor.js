var __slice = [].slice;
window.EquationEditor = {}, EquationEditor.Events = {on: function(t, n, o) {
        var e;
...
EquationEditor.ButtonGroupView = function(t) {
    ...
    return __extends(n, t), n.prototype.initialize = function() {
...
}(EquationEditor.View), EquationEditor.ButtonViewFactory = {create: function(config) {
        ...
        return buttons
    }}, EquationEditor.ButtonGroupViewFactory = {create: function(t) {
        var n, o, e, i;
