tinymce.create('tinymce.plugins.EquationEditorPlugin', {
  init: function(editor, url) {
    var editing, latexImgRendererUrl;
    latexImgRendererUrl = 'http://chart.apis.google.com/chart?cht=tx&chl=';
    pre_url = 'http://localhost/academico/libs/tinymce/plugins/equationeditor/';
    ...
    editor.addCommand('mceMathquill', function(existing_latex) {
      ...
      return popup = editor.windowManager.open({
        url: '' + pre_url + 'equation_editor.php',
        width: 720,
        height: 220,
        inline: 1,
        popup_css: false,
    ...
    editor.addCommand('mceMathquillInsert', function(latex) {
      ...
      //content = "&nbsp;<span class=\"rendered-latex\" contenteditable=\"false\">\n  " + latex + "\n</span>&nbsp;";
      content = "<img src=\"http://latex.codecogs.com/gif.latex?" + latex + "\" \>\n ";
      if (editing) {
