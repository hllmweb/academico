   ...
   private $prova_nova;
    ...
    function formata_texto_com_richtext($texto) {
        ...
        if($pos == TRUE){
            ...
            $texto_pronto = str_replace('<span class="mathquill-embedded-latex" >', '<img src="http://latex.codecogs.com/gif.latex?'.$formula[0].'" style="vertical-align:middle;"/>',$texto_pronto);
        }
		...
		//http://www.seculomanaus.com.br/gestordeprovas/assets/richtext/php/upload/
		    // $texto_pronto = str_replace('https://www.seculomanaus.com.br/academico/', base_url(),$texto_pronto);
        // $texto_pronto = str_replace('http://www.seculomanaus.com.br/academico/', base_url(),$texto_pronto);
        //
        // $texto_pronto = str_replace('http://www.seculomanaus.com.br/gestordeprovas/assets/richtext/php/upload', base_url('/upload/imagem_questao/'),$texto_pronto);
        //
        //
        // $texto_pronto = str_replace('http://server01.seculomanaus.com.br/academico/', base_url(),$texto_pronto);
    ...
    function formata_tirando_links_antigos($texto_pronto){
        $texto = str_replace('http://www.seculomanaus.com.br/academico/', base_url(),$texto_pronto);
        $texto = str_replace('https://www.seculomanaus.com.br/academico/', base_url(),$texto);

        $texto = str_replace('http://www.seculomanaus.com.br/gestordeprovas/assets/richtext/php/upload', base_url('/upload/imagem_questao/'),$texto);


        $texto = str_replace('http://server01.seculomanaus.com.br/academico/', base_url(),$texto);
        return $texto;
    }
    ...
    function formata_texto_com_richtext_alternativa($texto) {
        ...
        $texto_pronto = $this->formata_tirando_links_antigos($texto_pronto);
    //     $texto_pronto = str_replace('http://server01/academico/', base_url(),$texto_pronto);
    //
    //
		// $texto_pronto = str_replace('https://www.seculomanaus.com.br/academico/', base_url(),$texto_pronto);
    //     $texto_pronto = str_replace('http://www.seculomanaus.com.br/academico/', base_url(),$texto_pronto);
