                    ...
                    <form id="frmNovaPesquisa" class="form-inline">
                        ...
                        <div class="col-xs-10 pull-right">
                            ...
                            <div class="form-group col-xs-2 no-padding">
                                ...
                                <select id="FTMotivo" class="form-control input-sm" style="width: 80%; display: inline-block;">
                                    <option value="">TODOS</option>
                                    <?php foreach ($motivos as $row): ?>
                                        <option value="<?= $row->CD_MOTIVO ?>"><?= $row->NM_MOTIVO ?></option>
                                    <?php endforeach; ?>                                    
                                </select>                                
                                <a href="<?= base_url($this->session->userdata('SGP_SISTEMA').'/justificativa_solicitacao/modalMotivo') ?>" data-toggle="frmModalRegistro"><i class="fa fa-plus"></i></a>
                            </div>
