                        ...
                        <div class='btn-group'role='group'>
                            ...
                            <? if($texto == ''){ ?>
                                <button 
                                    ...
                                    data-remote='<?= base_url($this->session->userdata('SGP_SISTEMA') . "/tempos/mdlProfessorHorarioTempo/A:".$i.":".$j."") ?>'
                                >
                            ...
                            <? }else{ ?>
                                ...
                                <button type='button' 
                                    ...
                                    data-remote='<?= base_url($this->session->userdata('SGP_SISTEMA') . "/tempos/mdlHorarioEditarProfessor/".$idmanha['A'][$j][$i]."") ?>' 
                                >
                    ...
                    <? for ($j = 1; $j <= 6; $j++) { ?>
                        ...
                        <div class='btn-group'role='group'>
                            ...
                            <? if($texto == ''){ ?>
                                <button 
                                    type='button' class='btn btn-outline btn-info btnCadastrar<?=$id?>'
                                    data-remote='<?= base_url($this->session->userdata('SGP_SISTEMA') . "/tempos/mdlProfessorHorarioTempo/B:".$i.":".$j."") ?>'
                                >
                                    <i class='fa fa-plus'></i> Novo
                                </button>
                            <? }else{ ?>
                                ...
                                <button type='button' 
                                    class='btn btn-info btnCadastrar<?=$id?>'
                                    data-remote='<?= base_url($this->session->userdata('SGP_SISTEMA') . "/tempos/mdlHorarioEditarProfessor/".$idtarde['B'][$j][$i]."") ?>' 
                                >
                                    <i class='fa fa-edit'></i> Editar
                                </button>
