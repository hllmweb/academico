                    ...
                    <? foreach ($lista as $row) { ?>
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <button class="btn btn-success btn-circle" title="<?=(($row['STATUS'] == 1)? 'Liberar' : 'Retirar liberação')?>" href="<?=base_url(''.$this->session->userdata('SGP_SISTEMA').'/registro_diario/mdlRegistro/L-'.$row['CD_REGISTRO'].'')?>" data-toggle="frmModalAluno">
                                    <i class="<?=(($row['STATUS'] == 1)? 'fa fa-lock' : 'fa fa-unlock')?>"></i>
                                </button>
                                <button class="btn btn-danger btn-circle" title="Excluir" href="<?=base_url(''.$this->session->userdata('SGP_SISTEMA').'/registro_diario/mdlRegistro/D-'.$row['CD_REGISTRO'].'')?>" data-toggle="frmModalAluno">
