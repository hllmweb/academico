...
$(function(){
    ...
    function txtFiltrar() {
        $("#tblFiltro").html('<?= LOAD ?>');
        $.post("<?= base_url(''.$this->session->userdata('SGP_SISTEMA').'/faltas/grdRegistro') ?>", {
            curso: $("#FTCurso").val(),
            serie: $("#FTSerie").val(),
            turma: $("#FTTurma").val(),
        },
            ...
            <div class="panel-footer">
                <div class="row">
                    ...
                    <div class="form-inline col-xs-10 text-right">
                        <form action="<?= base_url(''.$this->session->userdata('SGP_SISTEMA').'/faltas/impRegistro') ?>" method="POST" target="_blank">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="submit" id="" class="btn btn-labeled btn-primary2">
