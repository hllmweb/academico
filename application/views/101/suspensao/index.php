...
$(function(){
    ...
    function txtFiltrar() {
        $("#tblFiltro").html('<?= LOAD ?>');
        $.post("<?= base_url(''.$this->session->userdata('SGP_SISTEMA').'/suspensao/grdRegistro') ?>", {
    ...
    <div class="row projects">
        <div class="hpanel hgreen">
            <div class="panel-footer">
                <div class="row">
                    <div class="col-xs-2">
                        <button href="<?=base_url(''.$this->session->userdata('SGP_SISTEMA').'/suspensao/mdlRegistro/A')?>" data-toggle="frmModal" type="button" id="" class="btn btn-labeled btn-primary2">
