...
$(function(){
    ...
    function txtFiltrar() {
        $("#tblFiltro").html('<?= LOAD ?>');
        $.post("<?= base_url(''.$this->session->userdata('SGP_SISTEMA').'/orientacao_docente/grdRegistro') ?>", {
            curso: $("#FTCurso").val(),
            serie: $("#FTSerie").val(),
            turma: $("#FTTurma").val(),
        },
    ...
    <div class="row projects">
        <div class="hpanel hgreen">
            <div class="panel-footer">
                <div class="row">
                    <div class="col-xs-2">
                        <button href="<?=base_url(''.$this->session->userdata('SGP_SISTEMA').'/orientacao_docente/mdlRegistro/A')?>" data-toggle="frmModal" type="button" id="" class="btn btn-labeled btn-primary2">
