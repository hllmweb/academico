<div class="modal-dialog modal-lg animated-panel zoomIn" style="animation-delay: 0.1s;">
    <div class="modal-content">
                    ...
                    <div class="col-xs-6">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><?=$aluno[0]['VL_QUESTAO']?></td>
                            </tr>
                            <tr>
                                <td class="text-left">Max Objetiva:</td>                                
                                <td><?=$aluno[0]['VL_T_OBJETIVA']?></td>
                            </tr>
                            <tr>
                                <td class="text-left">Max Discursiva:</td>                                
                                <td><?=$aluno[0]['VL_T_DISCURSIVA']?></td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-xs-6">
        ...
        <div class="modal-footer">
            ...
            <a class="btn btn-info" target="_blank" href="http://server01/gestordeprovas/banco/gabarito/frmImprimir/?id=<?= base64_encode($aluno[0]['CD_PROVA'])?>">
