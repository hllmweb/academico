...
<html class="no-js" lang="en">
    ...
    <body>
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="5" >
            <?php #if($prova[0]['CD_TIPO_PROVA'] == 5){ ?>
            <!-- <tr>
            ...
            <?php #}elseif($prova[0]['CD_TIPO_PROVA'] == 1 && $prova[0]['CD_CURSO'] == 3 && $prova[0]['ORDEM_SERIE'] == 3){ ?>
            <tr>
                <td height="100" width="80%" align="left" style="font-family: 'Arial Narrow'; font-size: 12px">
                    Curso: <?=$prova[0]['NM_CURSO_RED']?><br/>
                    Matrícula: <?php echo $aluno[0]['CD_ALUNO']?><br/>
                    Aluno(a): <?php echo $aluno[0]['NM_ALUNO']?><br/>
                    Prova: <?=$prova[0]['NUM_PROVA']?><br/>
                    Data: <?php echo (($prova[0]['DT_PROVA'] != '')? date('d/m/Y',strtotime(implode("-",array_reverse(explode("/",$prova[0]['DT_PROVA']))))):'')?><br/>
                </td>
                <td width="100px" style="border:1px solid #000">
                     <?php #$img = $aluno[0]['CD_ALUNO'].$prova[0]['NUM_PROVA'] ?>
            ...
            <tr>
               <td height="20" align="left" style="font-family: 'Arial Narrow'; font-size: 12px; text-align: justify;">
                        <ol style="list-style-type:decimal; text-align: justify">
                            ...
                            <li>Qualquer falha na impressão, da página ou falha de folhas, deve ser apresentada ao(a) <strong>PROFESSOR(A)</strong>, que a solucionará.</li>
                            <li> Assine sua avaliação no campo acima, antes de iniciar a resolução das questões.</li>
                            <li> Utilize o verso das folhas de rascunho, quando for necessário.</li>
                            <li> <strong>É PROIBIDO:</strong> pedir material emprestado, usar líquido corretor, calculadora e/ ou qualquer meio eletrônico de comunicação.</li>
                            <li> <strong>PORTAR (mesmo que não consulte)</strong> ou <strong>USAR</strong> meios ilicitos (cola) são considerados <strong>TRANSGRESSÕES GRAVES</strong>.<br> O aluno encontrado em qualquer dessas situações terá sua avaliação recolhida e ficará sujeito as sanções disciplinares decorrentes.</li>
                            <li> Nas questões de múltipla escolha, assinale apenas uma alternativa. </li>
                            <li> Questões rasuradas serão anuladas.</li>
                        </ol>
                </td>
            </tr>
        </table> 
            ...
            <tr>
               <td height="20" align="left" style="font-family: 'Arial Narrow'; font-size: 12px; text-align: justify;">
                    ...
                    <? }elseif($prova[0]['CD_TIPO_PROVA'] == 1 && $prova[0]['CD_CURSO'] == 3 && $prova[0]['ORDEM_SERIE'] == 3){ ?>
                               1. Antes de iniciar a resolução das questões, assine sua avaliação no campo acima;<br><br>
                           
                               2.  Esta avaliação consta de  72 (setenta e dois) questões objetivas, sendo 6 (seis) questões por disciplina valendo 0,14 (zero virgula quatorze) cada, sendo computada separadamente para cada disciplina.
                               Assim, o valor máximo da avaliação é de 10 (dez) pontos;<br><br>
                           
                               3. Sua prova é um documento, sendo assim, não serão aceitos desenhos, símbolos ou outros não pertinentes às questões da avaliação; <br><br>
                           
                               4. Só serão aceitas as questões objetivas respondidas com caneta esferográfica de cor azul ou preta; <br><br>
                              ...
                              6.  Utilize o verso das folhas para rascunho, quando for necessária; <br><br>
