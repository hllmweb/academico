...
<script type="text/javascript">
    ...
    (function(){
        ...
        $("#avalTTPontoObj").change(function(){
             $("#avalVlQuestaoObj").val("");
             let tt   = $("#avalTTPontoObj").val();
             let qtde = $("#avalQtdeObj").val();
             let vlquestao = $("#avalVlQuestaoObj").val();
           ...
           if(qtde != "" && tt !=""){
               ...
               var calc = tt/qtde;
                ...
                $("#avalVlQuestaoObj").val(calc.toFixed(4));
               // $("#resultado_calc").html((tt*qtde).toFixed(2));

            }

        });

          $("#avalQtdeObj").change(function(){
             $("#avalVlQuestaoObj").val("");
             let tt   = $("#avalTTPontoObj").val();
             let qtde = $("#avalQtdeObj").val();
             let vlquestao = $("#avalVlQuestaoObj").val();
           ...
           if(qtde != "" && tt !=""){
               ...
               var calc = tt/qtde;
                ...
                $("#avalVlQuestaoObj").val(parseFloat(calc.toFixed(4)));
...
<?php 
    $filtro = "valor = 0.0 AND cd_prova = ". $prova[0]['CD_PROVA'].""; 
    ...
    if($linha != 0){
        ...
        <div class="alert alert-danger" role="alert">
            Falta preencher alguma questão 
        </div>  
        ';
    }else{
        $html_valor = '
        <div class="alert alert-success" role="alert">
            Todos os valores das questões foram preenchidos!
        </div>  
        ';
    }
            ...
            <div class="hpanel hviolet">
                <div class="panel-heading">
                    ...
                    <? if($prova[0]['FLG_PEND_PROCESSAMENTO'] == 1){?>
                        ...
                        <a class="btn btn-warning" target="_blank" href="<?=base_url(''.$this->session->userdata('SGP_SISTEMA').'/impressao/'.(($prova[0]['CD_TIPO_PROVA']== 6)?'ingresso':'index').'?id='.$prova[0]['CD_PROVA'].'')?>" type="button"><i class="fa fa-eye"></i> PDF OBJETIVA</a>

                        <a class="btn btn-warning" target="_blank" href="<?=base_url(''.$this->session->userdata('SGP_SISTEMA').'/impressao/'.((($prova[0]['CD_TIPO_PROVA']== 6)?'discursiva':'discursiva').'?id='.$prova[0]['CD_PROVA'].''))?>" type="button"><i class="fa fa-eye"></i> PDF DISCURSIVA</a>


                        <a class="btn btn-info" href="<?= base_url($this->session->userdata('SGP_SISTEMA')); ?>/impressao/versao_imprime?id=<?=$prova[0]['CD_PROVA']?>" data-toggle="frmModal"><i class="fa fa-address-card"></i> Lista de Provas</a>



                        <a data-toggle="frmModal" class="btn btn-primary" href="<?='http://server01/academico_novo/provaonline/comissao/prova/index/?p='.base64_encode(json_encode($prova[0])).''?>" type="button"><i class="fa fa-eye"></i> PROVA ONLINE</a>
                ...
                <div class="panel-body no-padding">
                     ...
                     <div class="col-lg-1">
                        <div class="form-group">
                            <label>Exibir Nota: <?php
                                       ...
                                       $exibir = $exibe_resultado->result_array[0]['FLG_EXIBE_RESULTADO'];


                                    ?></label>
                            <select name="avalResultado" id="avalResultado" class="form-control m-b" disabled>
                                <option value=""> <?php if($exibir == 1){echo "SIM";}else{echo "Não";}  ?></option>
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            <label>Curso</label>
                            <select <?=$disabled?> readonly onchange="titulo();" name="avalCurso" id="avalCurso" class="form-control m-b">
                                <option value=""></option>
...
<? } ?>
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            <label>Série</label>
                            <select <?=$disabled?> readonly onchange="titulo();" name="avalSerie" id="avalSerie" class="form-control m-b">
                                <?
                                foreach ($serie as $s) {
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <select <?=$disabled?> readonly onchange="titulo();" name="avalBimestre" id="avalBimestre" class="form-control m-b">
                                <option value=""></option>
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <select <?=$disabled?> readonly onchange="titulo();" name="avalTipoNota" id="avalTipoNota" class="form-control m-b">
                                <option value=""></option>
...
<? } ?>
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            <label>Chamada</label>
                            <select <?=$disabled?> readonly onchange="titulo();" name="avalChamada" id="avalChamada" class="form-control m-b">
                                <option value=""></option>
                    ...
                    <!-- TEMPO PARA MOSTRAR O BOTÃO FINALIZAR  -->
                        <div class="col-lg-6">
                        <div class="form-group">
                            <label>Tempo para liberação do botão finalizar prova</label>
                            <div class="input-group">

                                <input id="minLiberacao" class="form-control" value="<?=($prova[0]['MIN_LIBERACAO']=="")?"30":$prova[0]['MIN_LIBERACAO']; ?>" name="minLiberacao" placeholder="mm" type="text" maxlength="5">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php if($prova[0]['CD_TIPO_PROVA'] == 2): ?>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label>Professor
                    ...
                    <?php else: ?>
                            <input type="hidden" name="avalProfessor" id="avalProfessor" value="00000" class="form-control"> 
                    <?php endif; ?>



                    <fieldset class="col-lg-6 well" style="display: none;">
                    ...
                    <?php if($prova[0]['CD_TIPO_PROVA'] <> 2){ ?>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>Gerar Nota</label>
                                 <select  name="gerarNota" id="gerarNota" class="form-control m-b">
                                    <option value="0" <?php echo($gerar_nota->result_array[0]['LIB_NOTA'] == 0 ? "selected":""); ?>>Não</option>
                                    <option value="1" <?php echo($gerar_nota->result_array[0]['LIB_NOTA'] == 1 ? "selected":""); ?>>Sim</option>
                                  </select>
                            </div>
                        </div>
                ...
                <div class="panel-heading">
                    ...
                    <? if ($prova[0]['CD_TIPO_PROVA'] == 2) { ?>
                        <? if (count($prova_disciplina) < 2) { ?>
                            <button class="btn btn-warning2" data-toggle="frmModal" href="<?= base_url('108/prova/mdlDisciplinasProva?prova=' . $prova[0]['CD_PROVA'] . '&curso=' . $prova[0]['CD_CURSO'].'&tipo='.$prova[0]['CD_TIPO_PROVA'].'&serie=' . $prova[0]['ORDEM_SERIE'] . '&operacao=I') ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td width="<?=(($prova[0]['FLG_PEND_PROCESSAMENTO'] == 1)? '20' : '5')?>%">
                                                    <? if($prova[0]['FLG_PEND_PROCESSAMENTO'] == 1){?>
                                                        ...
                                                        <a data-toggle="frmModalUpdate" href="<?= base_url(''.$this->session->userdata('SGP_SISTEMA').'/prova/mdlDisciplinasProva?prova=' . $pd['CD_PROVA'] . '&disciplina=' . $pd['CD_DISCIPLINA'] . '&tipo=' . $pd['TIPO_QUESTAO'] . '&curso=' . $prova[0]['CD_CURSO'] . '&serie=' . $prova[0]['ORDEM_SERIE'] . '&operacao=C' . '&id_aval_prova_disc='.$pd['ID_AVAL_PROVA_DISC']) ?>" class="btn btn-info btn-xs" >
                                                            <i class="fa fa-edit"></i> Editar <?php #echo $pd['ID_AVAL_PROVA_DISC'];?>
                                                        </a>
                                                        <!--<a data-toggle="frmModalDanger" href="<?php #echo base_url(''.$this->session->userdata('SGP_SISTEMA').'/prova/mdlDisciplinasProva?prova=' . $pd['CD_PROVA'] . '&disciplina=' . $pd['CD_DISCIPLINA'] . '&tipo=' . $pd['TIPO_QUESTAO'] . '&curso=' . $prova[0]['CD_CURSO'] . '&serie=' . $prova[0]['ORDEM_SERIE'] . '&operacao=D') ?>" class="btn btn-danger2 btn-xs" >
...
<script>
    ...
    $(function() {
        ...
        //Verifica se já existe uma prova com este horário e data cadastrado
       /*  $('#hrInicio').change(function() {


               $.post("<?= base_url('108/prova/verificaHorarioDuplicado') ?>", {
                cd_prova:$("#avalProva").val(),
                p_data:$(".avalDataProva").val(),
                hr_inicio: $("#hrInicio").val(),
                cd_curso : $("#avalCurso").val(),
                ordem_serie : $("#avalSerie").val()
                },
                function(data) {
                    ...
                    if(data != ""){
                            ...
                            text: data+" JÁ ESTÁ CADASTRADA NESTE HORÁRIO",
                            type: "warning",
