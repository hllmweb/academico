                    ...
                    <tbody>
                        ...
                        foreach ($listar as $row) {
                            ...
                            <tr>
                                ...
                                <td><?= $row['TITULO'] ?></td>
                                <td>
                                    <a class="btn btn-info btn-xs" onclick="window.open('<?=('http://server01/gestordeprovas/prova/index?id=' . $row['CD_PROVA'] . '') ?>');" >
                                        <i class="fa fa-print"></i> Objetiva
                                    </a>
                                    <a class="btn btn-success btn-xs" onclick="window.open('<?=('http://server01/gestordeprovas/prova/discursiva?id=' . $row['CD_PROVA'] . '') ?>');" >
