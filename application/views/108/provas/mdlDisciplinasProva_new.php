<div class="modal-dialog">
    ...
    <script type="text/javascript">
        ...
        function svDisciplina() {
            ...
            jQuery.ajax({
                type: "POST",
                surl: "<?= base_url('108/prova/frmManterProvaDisciplina_new') ?>",
                data: dados,
    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            <h4 class="modal-title">Disciplinas<?= $filtro[0]['ID_AVAL_PROVA_DISC'] ?></h4>
        </div>
            ...
            <form name="frmProvaDisiplina<?= $params ?>" id="frmProvaDisiplina<?= $params ?>">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-xs-6 border-right animated-panel zoomIn" style="animation-delay: 0.3s;">
                            <div class="form-group">
                        ...
                        <div class="col-xs-4  animated-panel zoomIn" style="animation-delay: 0.4s; display: none;">
                            <div class="form-group">
                ...
                <input type="text" name="id_aval_prova_disc"  value="<?= $filtro[0]['ID_AVAL_PROVA_DISC'] ?>" />
    ...
    <script>
        $(function() {
            $("#avalPosInicial<?= $filtro[0]['ID_AVAL_PROVA_DISC'] ?>").TouchSpin({
                min: 1,
                max: 100,
                step: 1,
                decimals: 0,
            ...
            $("#avalPosFinal<?= $filtro[0]['ID_AVAL_PROVA_DISC'] ?>").TouchSpin({
                min: 1,
                max: 100,
                step: 1,
                decimals: 0,
            ...
            $("#vlQuestao<?= $filtro[0]['ID_AVAL_PROVA_DISC'] ?>").TouchSpin({
                min: 0,
                max: 10,
                step: 0.0001,
                decimals: 4,
