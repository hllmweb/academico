...
class CI_Email {
	...
	var	$smtp_host		= "smtp.seculomanaus.com.br";	       // SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "sistema.web@seculomanaus.com.br";   // SMTP Username
	var	$smtp_pass		= "SistemaWeb2015!";                   // SMTP Password
